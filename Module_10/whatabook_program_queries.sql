...
/*
    Select query to view store's location 
*/
SELECT store_id, locale from store;

/*
    Select query to view a full listing of books WhatABook offers
*/
SELECT book_id, book_name, author, details from book;

/*
    Select query to view a listing of books not already in users wishlist.
...
/*
    Insert statement to add a new book to users wishlist. 
    The values will need to be replaced with actual values 
    the user selects from program
*/
INSERT INTO wishlist(user_id, book_id)
    VALUES(1, 9)

/*
    Remove a book from user wishlist.
    The user_id and book_id values will need to be replaced 
    with the actual values user selects from program
*/
